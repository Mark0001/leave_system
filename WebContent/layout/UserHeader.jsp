    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li id="empMvc"><a id ="notice" href="${pageContext.request.contextPath}/UserServlet?act=listEdit">修改假單</a></li>  <!--直接送到servlet處理-->
            </ul>
...
<img id =img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTWm8ooBn7Lni_ISJSXsn2ZQpDGuroiweAYH6rj3Mp6RWqoNzFgA" width="20">